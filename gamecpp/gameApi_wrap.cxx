...
#define SWIGV8_INIT Game_initialize




static SwigV8ReturnValue _wrap_gcd(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_gcd.");
...
static void _wrap_Foo_set(v8::Local<v8::String> property, v8::Local<v8::Value> value,
  const SwigV8PropertyCallbackInfoVoid &info) {
  SWIGV8_HANDLESCOPE();
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "Foo_set" "', argument " "1"" of type '" "double""'");
  } 
  arg1 = (double)(val1);
  Foo = arg1;
...
static SwigV8ReturnValue _wrap_Foo_get(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
  SWIGV8_HANDLESCOPE();
...
#endif
{
  ...
  SWIGV8_AddStaticVariable(exports_obj, "Foo", _wrap_Foo_get, _wrap_Foo_set);
  ...
  SWIGV8_AddStaticFunction(exports_obj, "gcd", _wrap_gcd);
...
NODE_MODULE(Game, Game_initialize)
#endif
